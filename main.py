...
async def salmon_run_indeed3(ctx: discord.Interaction):
	...
	embed3=discord.Embed(title="ブキ", color=0x9B95C9)
	embed3.add_field(name="ブキ①", value=weapons[0]['name'])
	embed3.add_field(name="ブキ②", value=weapons[1]['name'])
	embed3.add_field(name="ブキ③", value=weapons[2]['name'])
	embed3.add_field(name="ブキ④", value=weapons[3]['name'])
